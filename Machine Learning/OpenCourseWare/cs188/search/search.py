...
def depthFirstSearch(problem):
    ...
    def find_path(problem, src_state, actions, states):
        ...
        for dst_state, direction, cost in problem.getSuccessors(src_state):
            ...
            if find_path(problem, dst_state, actions, states):
                return True
            states.discard(dst_state)
            actions.pop()
        return False

    actions = []
    find_path(problem, problem.getStartState(), actions, set())
    return actions
...
def breadthFirstSearch(problem):
    ...
    while not queue.isEmpty():
        ...
        for dst_state, direction, cost in problem.getSuccessors(src_state):
            ...
            queue.push((dst_state, dst_actions))
    return []
