...
class KeyDisplay(cocos.layer.Layer):
	...
	def __init__(self):
		...
		self.text=cocos.text.Label("",x=100,y=320)
...
main_scene=cocos.scene.Scene(NowKeyDisplay(),KeyDisplay(),MouseDisplay())
